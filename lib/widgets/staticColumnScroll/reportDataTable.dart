...
class ReportGridStyleModel{
  ...
  ReportGridStyleModel({this.columnName,this.width=150,this.alignment=Alignment.centerLeft,
    this.edgeInsets=const EdgeInsets.only(left: 10),this.isActive=true});
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.start,
                                      ...
                                      children: widget.gridDataRowList.asMap().map((j, v) {
                                        ...
                                        if((10.0*value.get(v.columnName).toString().length)>v.width){
                                          setState(() {
                                            v.width=10.0*value.get(v.columnName).toString().length;
                                          });
                                        }
