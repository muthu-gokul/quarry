...
class GridStyleModel3{
  String? columnName;
  double width;
  Alignment alignment;
  EdgeInsets edgeInsets;
  GridStyleModel3({this.columnName,this.width=150,this.alignment=Alignment.centerLeft,
    this.edgeInsets=const EdgeInsets.only(left: 10)});
}

class CustomDataTable3 extends StatefulWidget {
  ...
  CustomDataTable3({this.gridDataRowList,this.gridData,this.selectedIndex,this.voidCallback,this.func,this.topMargin,this.gridBodyReduceHeight});
  @override
  _CustomDataTable3State createState() => _CustomDataTable3State(gridDataRowList: gridDataRowList,voidCallback: voidCallback);
}

class _CustomDataTable3State extends State<CustomDataTable3> {
  ...
  _CustomDataTable3State({this.gridDataRowList,this.voidCallback});
                            ...
                            map((i, value) => MapEntry(
                              ...
                              child:  Container(
                                ...
                                child: Container(
                                  ...
                                  child: FittedBox(
                                    fit: BoxFit.contain,
                                    child: Text("${value[gridDataRowList![0].columnName]}",
                                      style:widget.selectedIndex==i?AppTheme.bgColorTS14:AppTheme.gridTextColor14,
                                    ),
                                  ),
                                ),
