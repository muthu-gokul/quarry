...
import './enums.dart';
import 'utils/src/barcode.dart';
import 'utils/src/capability_profile.dart';
import 'utils/src/enums.dart';
import 'utils/src/generator.dart';
import 'utils/src/pos_column.dart';
import 'utils/src/pos_styles.dart';
import 'utils/src/qrcode.dart';
...
class NetworkPrinter {
  ...
  Future<PosPrintResult> connect(String host,
      {int port = 9100, Duration timeout = const Duration(milliseconds: 400)}) async {
    _host = host;
    _port = port;
    try {
