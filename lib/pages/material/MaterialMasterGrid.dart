                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SingleChildScrollView(
                        ...
                        child:DataTable(
                            ...
                            rows: qn.materialGridList.asMap().map((i,e) => MapEntry(i, DataRow(cells: [
                              ...
                              DataCell(Text(e.UnitName,style: TextStyle(fontFamily: 'RR',fontSize: 14,color: Colors.black),),
                                  onTap: (){
                                    setState(() {
                                      selectedIndex=i;
                                      showEdit=!showEdit;
                              ...
                              DataCell(Text(e.MaterialUnitPrice!=null?e.MaterialUnitPrice.toString():'0.00',style: TextStyle(fontFamily: 'RR',fontSize: 14,color: Colors.black),),
                                  onTap: (){
                                    setState(() {
                                      selectedIndex=i;
                                      showEdit=!showEdit;
                              ...
                              DataCell(Text(e.MaterialTaxValue!=null?e.MaterialTaxValue.toString():'0.00',style: TextStyle(fontFamily: 'RR',fontSize: 14,color: Colors.black),),
                                  onTap: (){
                                    setState(() {
                                      selectedIndex=i;
                                      showEdit=!showEdit;
