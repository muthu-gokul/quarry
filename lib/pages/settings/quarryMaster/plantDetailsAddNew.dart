...
////////////////////////////////////  LICENSE LIST ///////////////////////
                                                      ...
                                                      children: [
                                                        GestureDetector(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Icon(Icons.download_rounded,size: 20,color: AppTheme.yellowColor,),
                                                          ),
                                                        ),
                                                        Text("${qn.PO_PlantLicenseList[index].licenseNumber}",
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child:qn.licenseDoc!=null?Icon(Icons.done,color: Colors.green,size: 35,): Icon(Icons.upload_rounded,color: AppTheme.yellowColor,),
                          ),
                        ),
                      ),
                        ...
                        onTap: () async {
                          if(isEdit){
                            ...
                            if(qn.PD_LicenseNo.text.isEmpty){
                              ...
                              qn.licenseLogo="";
                              if(qn.licenseDoc!=null){
                                qn.licenseLogo=await uploadFile(qn.licenseLogoFolder,qn.licenseDoc!);
                                print("licenseLogo ${qn.licenseLogo}");
                              }
                              setState(() {
                                qn.PO_PlantLicenseList.add(
                                    PlantLicenseModel(
                                        ...
                                        toDate: qn.PD_toDate,
                                        documentFileName: qn.licenseLogo,
                ...
                image: "assets/images/saleFormheader.jpg",
              ),
