...
class EmployeeSalaryGrid extends StatefulWidget {
  ...
  @override
  _EmployeeSalaryGridState createState() => _EmployeeSalaryGridState();
}
...
class _EmployeeSalaryGridState extends State<EmployeeSalaryGrid> {
                        ...
                        child:Row(
                          ...
                          children: [
                            ...
                            ReportHeader(
                              ...
                              value: esn.totalEmployees,
                            ),
                            ReportHeader(
                              title: 'Total Salary',
                              value: esn.totalSalary,

                            ),
                            ReportHeader(
                              title: 'Total NetPay',
                              value: esn.totalNetPay,
                            ),
                          ],
                        )
                    ),
                ...
                setState(() {
                  ...
                  showEdit=true;
                    ...
                    Align(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          esn.GetEmployeeSalaryDbHit(context, null);
  ...
  Route _createRoute() {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => EmployeeSalaryAddNew(),
