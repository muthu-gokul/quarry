...
class CusSupDashBoard extends StatefulWidget {

  VoidCallback? drawerCallback;
  CusSupDashBoard({this.drawerCallback});
  @override
  _CusSupDashBoardState createState() => _CusSupDashBoardState();
}

class _CusSupDashBoardState extends State<CusSupDashBoard> {
